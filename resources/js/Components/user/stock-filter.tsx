...
export function StockFilter({ filters, sectorOptions, exchangeOptions }: StockFilterProps) {
    const valuesFromFilters = (): StockFilters => ({
    ...
    const [values, setValues] = useState<StockFilters>(valuesFromFilters);
    const [appliedFilters, setAppliedFilters] = useState(filters);

    // Đồng bộ lại form khi bộ lọc từ server (URL) thay đổi, set state trong render
    // thay vì useEffect để tránh cascading re-render.
